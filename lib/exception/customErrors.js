...
module.exports = {
  ...
  CONTRACT_EXECUTE_FAIL: {
    CODE: 15029,
    MSG: 'contract execute fail',
  },
  CONTRACT_SYNTAX_ERROR: {
    CODE: 15030,
    MSG: 'contract syntax error',
  },
  CONTRACT_TOO_MANY_RECURSION: {
    CODE: 15031,
    MSG: 'contract too many recursion',
  },
  CONTRACT_TOO_MANY_TRANSACTIONS: {
    CODE: 15032,
    MSG: 'contract too many transactions',
  },
  CONTRACT_EXECUTE_EXPIRED: {
    CODE: 15033,
    MSG: 'contract execute expired',
  },
  INVALID_INPUT_ERROR: {
    CODE: 15028,
    MSG: 'invalid input',
